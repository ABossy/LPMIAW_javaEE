...
public class GestionFactory {
	...
	private static HashMap<Integer, Etudiant> intializeListEtudiants() {
		...
		Etudiant etu3 = new Etudiant(2, "Pierrick", "Loiacono");
		Etudiant etu4= new Etudiant(3, "Marie", "Kersale");
	...
	private static final HashMap<Integer, Integer> intializelistEtudiantAbsence() {
		...
		listEtudiantAbsenceTemp.put(listEtudiants.get(2).getId(), 5);
		listEtudiantAbsenceTemp.put(listEtudiants.get(3).getId(), 10);
